...
@interface PODetailsViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UIActionSheetDelegate, UITextViewDelegate, HTTPRequestDelegate, PaymentDelegate, CustomAlertViewDelegate> {
    ...
    IBOutlet UIView *delete_order_view, *footerView, *opened_order_bar, *closed_order_bar, *fulfilled_order_bar, *no_payment_view, *available_payment_view, *notes_view, *ok_btn_view, *send_btn_view, *credit_card_alert, *payNow_alert_view, *convenience_footer_view, *pickUpTime_footer_view, *beverage_alert_view, *edit_gratuity_link_view;
